...
struct net_device_ops xbee_ops = {
		.ndo_set_mac_address 	= xbee_mac_addr,
		.ndo_validate_addr		= xbee_validate_addr,
		.ndo_open            	= xbee_open,
		.ndo_stop            	= xbee_release,
		.ndo_start_xmit 		= xbee_tx,
		.ndo_do_ioctl        	= xbee_ioctl,
		.ndo_get_stats       	= xbee_stats
};
